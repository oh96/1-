...
<body>
   ...
   <button onclick="MypageCommentDelete()">삭제</button>
      <thead>
         <tr>
...
function drawList(list){
   ...
   for(var i=0;i<list.length;i++){
      content += '<tr>';
      content +='<td><input type="checkbox" value="'+list[i].comment_idx+'"/></td>';
...
function MypageCommentDelete(){
   ...
   $.ajax({
      type:'get',
      url:'MypageCommentDelete',
      data:{'MypageCommentDeleteList':chkArr},
      dataType:'JSON',
      success:function(data){
         console.log(data);
         if(data.msg != ""){
